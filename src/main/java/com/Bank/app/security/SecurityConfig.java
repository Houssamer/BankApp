       ...
       http
        ...
        http
                ...
                .antMatchers("/api/client/update")
                    .hasAnyAuthority(AppUserRole.Client.name())
                .antMatchers("/api/client/*")
                    .hasAnyAuthority(AppUserRole.Employee.name(), AppUserRole.SysAdmin.name())
                .antMatchers("/api/employee/*")
                    .hasAnyAuthority(AppUserRole.Manager.name(), AppUserRole.SysAdmin.name())
                ...
                .antMatchers("/api/operations/transfer", "/api/operations/withdraw", "/api/operations/deposit")
                    .hasAnyAuthority(
                            AppUserRole.Client.name(), AppUserRole.Employee.name(), AppUserRole.SysAdmin.name())
                .antMatchers("/api/operations/account/*")
                    .hasAnyAuthority(AppUserRole.Client.name(), AppUserRole.Employee.name(), AppUserRole.SysAdmin.name())
